...
длина окружности. Необходима что бы расичтать в дашаррей
...
let wiewStatusLoad = document.querySelector(".js-load-progress"); // Replacement of readings in the center.
